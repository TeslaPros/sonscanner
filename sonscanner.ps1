                        ...
                        <Grid x:Name="SettingsPage" Visibility="Collapsed">
                            <Border Background="{StaticResource CardBackground}" BorderBrush="{StaticResource BorderBrush}" BorderThickness="1" CornerRadius="14" Padding="32">
                                <StackPanel Width="600" HorizontalAlignment="Left">
                                    ...
                                    <TextBlock Text="DEFAULT ENGINE VECTOR LEVEL" Foreground="{StaticResource TextSecondary}" Margin="0,0,0,8" FontSize="11" FontWeight="Bold" LetterSpacing="0.5"/>
                                    ...
                                    <CheckBox x:Name="AnimationsCheck" Content="Render Complex Kinematics Window Transposition Animations" IsChecked="True" Foreground="White" Margin="0,0,0,28"/>
...
# Custom TitleBar Drag & Double Click Window Controls
...
# Fast Fire Control Panel Triggers
...
# Dynamic Configuration Matrix Buffers
(Get-Control 'SaveSettingsButton').Add_Click({
    ...
    [System.Windows.MessageBox]::Show('Transient settings loaded dynamically into runtime memory stacks.', 'Son Scanner Framework', 'OK', 'Information') | Out-Null
})
...
# Hardware Snapshot Initialization
try {
    $os = Get-CimInstance Win32_OperatingSystem
...
# Window Initial Fade Kinematics Animation Trigger

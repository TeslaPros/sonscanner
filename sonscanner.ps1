...
# =========================================================================================
try {
    # XamlReader.Load accepteert geen StringReader rechtstreeks op alle PowerShell/.NET-versies.
    # Maak daarom expliciet een XmlReader aan en geef die door aan XamlReader.Load.

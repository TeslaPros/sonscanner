...
# =========================================================================================
# INLINE XAML INTERFACE (Single Here-String)
# =========================================================================================
$xaml = @'
<Window
                    ...
                    <ControlTemplate TargetType="Button">
                        <Border x:Name="NavBorder" Background="{TemplateBinding Background}" CornerRadius="8" Padding="12,0,12,0">
                            <Grid>
                                ...
                                <ContentPresenter x:Name="IconHost" Grid.Column="0" VerticalAlignment="Center" HorizontalAlignment="Left"/>
    ...
    <Border CornerRadius="16" Background="{StaticResource MainBgGradient}" BorderBrush="{StaticResource BorderSoftBrush}" BorderThickness="1.5" ClipToBounds="True">
        <Grid x:Name="MainGrid">
            ...
            <Canvas IsHitTestVisible="False" x:Name="BackgroundCanvas">
                ...
                <Ellipse Width="500" Height="500" Canvas.Right="-100" Canvas.Bottom="-100" Opacity="0.2">
                    <Ellipse.Fill>
                        <RadialGradientBrush>
                ...
                <Border Grid.Row="0" x:Name="TitleBar" Background="#A6020617" BorderBrush="{StaticResource BorderSoftBrush}" BorderThickness="0,0,0,1">
                    <Grid Margin="16,0,16,0">
                        ...
                        <StackPanel Grid.Column="0" Orientation="Horizontal" VerticalAlignment="Center">
                            ...
                            <TextBlock x:Name="TxtAppName" Text="Example" Foreground="{StaticResource TextPrimaryBrush}" FontSize="15" FontWeight="Bold" LetterSpacing="0.5"/>
                ...
                <Grid Grid.Row="1">
                    ...
                    <Border Grid.Column="0" Background="{StaticResource SidebarBgBrush}" BorderBrush="{StaticResource BorderSoftBrush}" BorderThickness="0,0,1,0" Padding="16,24,16,16">
                        <Grid>
                            ...
                            <TextBlock Grid.Row="0" Text="NAVIGATION" FontSize="11" FontWeight="Bold" Foreground="{StaticResource TextMutedBrush}" Margin="8,0,0,12" LetterSpacing="1"/>

                            <StackPanel Grid.Row="1">
                                <Button x:Name="NavBtn1" Content="Example Hub" Style="{StaticResource NavButtonStyle}" Tag="Active">
                                    <Button.ContentInner>
                                        <Path Data="M2,4 L20,4 L20,8 L20,18 L2,18 Z" Stroke="{StaticResource TextSecondaryBrush}" StrokeThickness="1.5" Width="14" Height="14" Stretch="Uniform"/>
                                    </Button.ContentInner>
                                </Button>
                                <Button x:Name="NavBtn2" Content="Example Analytics" Style="{StaticResource NavButtonStyle}">
                                    <Button.ContentInner>
                                        <Path Data="M2,18 L6,10 L12,14 L20,4" Stroke="{StaticResource TextSecondaryBrush}" StrokeThickness="1.5" Width="14" Height="14" Stretch="Uniform"/>
                                    </Button.ContentInner>
                                </Button>
                                <Button x:Name="NavBtn3" Content="Example Actions" Style="{StaticResource NavButtonStyle}">
                                    <Button.ContentInner>
                                        <Path Data="M12,2 A10,10 0 1 0 22,12" Stroke="{StaticResource TextSecondaryBrush}" StrokeThickness="1.5" Width="14" Height="14" Stretch="Uniform"/>
                                    </Button.ContentInner>
                                </Button>
                            </StackPanel>
                    ...
                    <Grid Grid.Column="1" Margin="24">
                        ...
                        <Grid Grid.Row="0" Margin="0,0,0,20">
                            <StackPanel>
                                <TextBlock x:Name="TxtMainTitle" Text="Example Main Title" Foreground="{StaticResource TextPrimaryBrush}" FontSize="28" FontWeight="Bold" LetterSpacing="-0.5"/>
                        ...
                        <TabControl Grid.Row="1" x:Name="ViewTabControl" BorderThickness="0" Background="Transparent">
                            ...
                            <TabItem>
                                <Grid>
                                    ...
                                    <Border Grid.Column="0" Style="{x:Null}" Background="{StaticResource PanelBgBrush}" BorderBrush="{StaticResource BorderSoftBrush}" BorderThickness="1" CornerRadius="14" Padding="20" Margin="0,0,16,0">
                                        <Grid>
                                            <StackPanel>
            ...
            <Canvas IsHitTestVisible="False">
                <Border x:Name="ToastNotificationCard" Width="320" Height="74" Background="#1E293B" BorderBrush="{StaticResource ElectricBlueBrush}" BorderThickness="1" CornerRadius="10" Padding="16,12,16,12" Canvas.Right="-340" Canvas.Top="64" Opacity="0">
                    <Grid>
                        <Grid.ColumnDefinitions>
...
try {
    ...
    [System.Windows.MessageBox]::Show("Example Critical Error: XAML parser engine encountered data formulation issues. Check composition alignment.")
    Exit
}
...
$ShowToastNotification = {
    ...
    $ToastNotificationCard.BeginAnimation([System.Windows.Controls.Canvas]::RightProperty, $slideAnim)
    ...
    $closeTimer.Add_Tick({
        ...
        $ToastNotificationCard.BeginAnimation([System.Windows.Controls.Canvas]::RightProperty, $slideOut)

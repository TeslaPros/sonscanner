            ...
            <Grid>
                ...
                <Border Background="#0D0D14" CornerRadius="25,0,0,25" BorderBrush="#1F1F2E" BorderThickness="0,0,1.5,0">
                    <Grid Margin="25,40">
                        ...
                        <StackPanel>
                            <TextBlock Text="ASTRA" Foreground="White" FontSize="28" FontWeight="Black" LetterSpacing="3"/>
                            <TextBlock Text="ULTIMATE" Foreground="#00F5FF" FontSize="12" FontWeight="Bold" Margin="2,-5,0,30" LetterSpacing="5"/>
...
# Map XAML items automatically without XML crashes
...
# Active Floating Background Glow Anims

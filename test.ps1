        ...
        <Grid Margin="18,0,10,0">
          ...
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            ...
            <StackPanel Margin="11,0,0,0" VerticalAlignment="Center">
              <TextBlock Text="TESLA TOOLS" FontSize="15" FontWeight="Bold" Foreground="White"/>
              <TextBlock Text="FORENSIC LAUNCH PLATFORM" FontSize="8" Foreground="#60748D"/>
            </StackPanel>
          </StackPanel>
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
 ...
 <Border Background="#070B12" BorderBrush="#00E5FF" BorderThickness="1" CornerRadius="18" Padding="26">
  ...
  <Grid><Grid.RowDefinitions><RowDefinition Height="*"/><RowDefinition Height="58"/></Grid.RowDefinitions>
   <StackPanel>
    <TextBlock Text="TESLA TOOLS" FontSize="25" FontWeight="Bold" Foreground="White"/>
    <TextBlock Text="SECURITY NOTICE" FontSize="9" FontWeight="Bold" Foreground="#00E5FF" Margin="0,4,0,22"/>

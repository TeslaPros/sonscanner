        ...
        <Grid Margin="20,0,12,0">
          ...
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            ...
            <StackPanel Margin="14,0,0,0" VerticalAlignment="Center">
              <TextBlock Text="TESLA TOOLS PLATFORM" FontSize="16" FontWeight="Black" Foreground="White"/>
              <TextBlock Text="NEXT-GEN DIGITAL FORENSICS HUB" FontSize="8.5" Foreground="#4A658A" FontWeight="SemiBold"/>
            </StackPanel>
          </StackPanel>
        ...
        <Border Grid.Column="0" Background="#060A17" CornerRadius="0,0,0,20" BorderBrush="#142142" BorderThickness="0,0,1,0">
          <Grid Margin="18">
            ...
            <StackPanel Grid.Row="1" Margin="0,22,0,0">
              <TextBlock Text="SYSTEM OPERATORS" Foreground="#4A658A" FontSize="9.5" FontWeight="Black" Margin="4,0,0,10"/>
        ...
        <Grid Grid.Column="1" Margin="22">
          ...
          <Border Grid.Row="0" CornerRadius="16" Background="#0C1425" BorderBrush="#192A4D" BorderThickness="1" Padding="20,15">
            ...
            <Grid>
              ...
              <Border Grid.Column="1" Background="#102B42" BorderBrush="#00F2FE" BorderThickness="1" CornerRadius="8" Padding="14,7" VerticalAlignment="Center" Margin="0,0,18,0">
                <TextBlock x:Name="StatusBadge" Text="IDLE" Foreground="#00F2FE" FontWeight="Black" FontSize="11"/>
              </Border>
          ...
          <Border Grid.Row="4" CornerRadius="16" Background="#040712" BorderBrush="#142342" BorderThickness="1" Padding="16,12">
            <Grid>
              ...
              <TextBlock Text="SYSTEM DIAGNOSTICS STREAM" Foreground="#4A658A" FontSize="9.5" FontWeight="Black"/>
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
 ...
 <Border Background="#050814" BorderBrush="#00F2FE" BorderThickness="1.5" CornerRadius="20" Padding="30">
  ...
  <Grid><Grid.RowDefinitions><RowDefinition Height="*"/><RowDefinition Height="60"/></Grid.RowDefinitions>
   <StackPanel>
    <TextBlock Text="TESLA SUITE" FontSize="28" FontWeight="Black" Foreground="White"/>
    <TextBlock Text="EULA &amp; FORENSIC DISCLOSURE" FontSize="9" FontWeight="Black" Foreground="#00F2FE" Margin="0,4,0,24"/>
   ...
   <Grid Grid.Row="1"><Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="15"/><ColumnDefinition Width="*"/></Grid.ColumnDefinitions>
    <Button x:Name="CancelBtn" Grid.Column="0" Content="Decline" Height="44" Background="#0A1021" Foreground="#8FA3BF" BorderBrush="#1D2E54" Cursor="Hand" Style="{x:Null}"><Button.Resources><Style TargetType="Button"><Setter Property="Template"><Setter.Value><ControlTemplate TargetType="Button"><Border Background="{TemplateBinding Background}" BorderBrush="{TemplateBinding BorderBrush}" BorderThickness="1" CornerRadius="10"><ContentPresenter HorizontalAlignment="Center" VerticalAlignment="Center"/></Border></ControlTemplate></Setter.Value></Setter></Style></Button.Resources></Button>
    <Button x:Name="AcceptBtn" Grid.Column="2" Content="Accept Framework" Height="44" Background="#112F47" Foreground="#00F2FE" BorderBrush="#00F2FE" Cursor="Hand" FontWeight="Bold" Style="{x:Null}"><Button.Resources><Style TargetType="Button"><Setter Property="Template"><Setter.Value><ControlTemplate TargetType="Button"><Border Background="{TemplateBinding Background}" BorderBrush="{TemplateBinding BorderBrush}" BorderThickness="1.5" CornerRadius="10"><ContentPresenter HorizontalAlignment="Center" VerticalAlignment="Center"/></Border></ControlTemplate></Setter.Value></Setter></Style></Button.Resources></Button>
   </Grid>
  </Grid>
 </Border>
</Window>
...
try {
    ...
    Write-Error "Disclaimer-XAML kon niet worden geladen: $($_.Exception.Message)"
    exit 1
}
...
try {
    ...
    Write-Error "Hoofdvenster-XAML kon niet worden geladen: $($_.Exception.Message)"
    exit 1
}
